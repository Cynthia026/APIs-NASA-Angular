...
// Importamos los 6 modelos correctos
import { 
  ...
  <div class="shell">
    <header class="top">
      <div class="brand">
        ...
        <div class="title">
          <h1>Explorer API</h1>
          <p>APIs de la NASA con Endpoints</p>
        </div>
      </div>
...
export class AppComponent {
  ...
  // Variables que guardan los datos de las 6 APIs
  ...
  // Esta función es la que muestra el endpoint dinámico en el banner
  ...
  loadData(mode: ViewMode) {
    ...
    // Lógica para consumir los servicios según la pestaña
    switch (mode) {
      case 'APOD':
